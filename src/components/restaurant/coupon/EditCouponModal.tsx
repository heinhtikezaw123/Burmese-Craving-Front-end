...
const EditCouponModal: React.FC<Props> = ({ isOpen, onClose, coupon, onUpdated }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Edit Coupon" size="md">
            <div className="flex flex-col gap-3">
                ...
                <Button onClick={handleUpdate} label="Update" className="w-full" />
            </div>
        </Modal>
    );
};
