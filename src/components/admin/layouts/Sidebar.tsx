...
const menuByRole: Record<UserRole, MenuItem[]> = {
    superAdmin: [
        ...
        { label: "Cateogries", path: "/admin/dashboard/category" },
        { label: "Vendors", path: "/admin/dashboard/vendors" },
        { label: "Customers", path: "/admin/dashboard/customers" },
        { label: "Coupons", path: "/admin/dashboard/coupons" },
        { label: "Setting", path: "/admin/dashboard/setting" },
    ],
    vendor: [
